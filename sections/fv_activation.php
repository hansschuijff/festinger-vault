                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form class="form" id="ajax-license-refill-form" action="#">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <p>
                                                                            <b>Note:</b> You can use your onetime purchased
                                                                            license key as refill key if that is not previously used or activated as license.
                                                                            Once you redeem, it will add balance with current key.
                                                                        </p>
                                                                    </div>
                                ...
                                if ( fv_get_license_key() == $all_license_data->license_1->license_data->license_key ):
                                    ...
                                    <form class="ajax-license-deactivation-form" action="#">
                                        <input type="hidden" required id="license_key" name="license_key"
                                            value="<?php echo $get_license_own_db ; ?>">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                unused ONETIME Plan license Key
                                                                            </label>
                                                                            <input
                                                                                type="text"
                                                                        ...
                                                                        <div id="credit_refill_msg"></div>
                                                                        <p>
                                                                            <b>Note:</b> You can use your onetime purchased license key as refill key if that is not previously used or activated as license. Once you redeem, it will add balance with current key.
                                                                        </p>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            style="height:29px; margin-top:4px;font-size:16px!important;">
                                                                            Redeem & Refill Now
                                                                        </button>
                                                                    </div>
                                                                </form>
                                ...
                                if ( fv_get_license_key_2() == $all_license_data->license_2->license_data->license_key ):
                                    ...
                                    <form class="ajax-license-deactivation-form-2" action="#">
                                        <input
                                            ...
                                            id="license_key_2"
                                            name="license_key_2"
                                            value="<?php echo $get_license_own_db_2 ; ?>"
                                            required>
                                        <input
                                            type="hidden"
                                            id="license_d_2"
                                        ...
                                        <button
                                            type="submit"
                                            class="btn primary-btn btn-sm non_active_button">
                                            Remove License
                                        </button>
                                    </form>
                                <?php
                                ...
                                <div class="card-body card-bottom-border">
                                    <form class="form" id="ajax-license-activation-form" action="#">
                                        <div class="mb-3">
                                            ...
                                            <input
                                                type="text"
                                                class="form-control search_bg_clr"
                                                id="licenseKeyInput"
                    ...
                    <div class="card-footer ">
                        <div class="dark-blue border-8 py-3 px-4 mt-4">
                            <small class="">
                                ...
                                <?php else: ?>
                                        You are registering your license with <b><?php echo get_home_url(); ?></b> domain.
                                    </small>
                                <?php endif; ?>
                        </div>
                    </div>
